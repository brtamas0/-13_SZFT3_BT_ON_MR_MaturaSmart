  ...
  <div class="min-h-screen bg-[#020617] flex items-center justify-center text-white relative overflow-hidden p-4 font-sans">
    ...
    <div class="relative w-full max-w-5xl z-10">
      <div class="grid md:grid-cols-2 rounded-3xl overflow-hidden border border-white/10 shadow-2xl bg-[#020617]">
        ...
        <div class="bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#312e81] p-8 md:p-12 relative flex flex-col min-h-[600px] overflow-hidden">
            ...
            <div class="relative z-20 self-start animate-fade-in-down">
                <div class="bg-white text-slate-900 text-sm font-medium px-5 py-3 rounded-2xl rounded-br-none shadow-xl transform -rotate-2 max-w-[220px]">
            ...
            <div class="w-full max-w-sm mx-auto">
                ...
                >
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                        ...
                        <path d="M12 4.36c1.6 0 3.06.56 4.23 1.69l3.18-3.18C17.45 1.14 14.97 0 12 0 7.7 0 3.99 2.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
                    </svg>
